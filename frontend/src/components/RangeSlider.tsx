...
export function RangeSlider(props: Props) {
  return (
    <>
      <style>
        {`
        .wk-range { -webkit-appearance: none; appearance: none; height: 6px; background: #e5e7eb; border-radius: 9999px; outline: none; cursor: pointer; }
        .wk-range::-webkit-slider-runnable-track { height: 6px; background: #e5e7eb; border-radius: 9999px; }
